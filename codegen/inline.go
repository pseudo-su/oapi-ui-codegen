...
func GenerateInlinedSpecUI(t *template.Template) (string, error) {
	return generateInlinedPage(t, "SwaggerUIPage", "swaggerui.html", "openapi specification corresponding to the generated code in this file")
}
...
func GenerateInlinedSpecRedirect(t *template.Template) (string, error) {
	return generateInlinedPage(t, "Oauth2RedirectPage", "oauth2-redirect.html", "oauth2 redirect page corresponding to the generated code in this file")
}

func generateInlinedPage(t *template.Template, code, filename, description string) (string, error) {
