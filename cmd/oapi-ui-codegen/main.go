...
import (
	...
	"github.com/pseudo-su/oapi-ui-codegen/codegen"
	"github.com/pseudo-su/oapi-ui-codegen/util"
)
...
func main() {
	...
	flag.StringVar(&generate, "generate", "spec,swaggerui",
		`Comma-separated list of code to generate; valid options: "skip-fmt", "spec", "swaggerui"  (default "spec","swaggerui")`)
